...
const Login = ({ setLogin, SetRequestId ,setPhoneNumberEntered}) => {
  ...
  const handleLogin = async () => {
    try {
      ...
      setPhoneNumberEntered(`${selectedCountry}${phoneNumber}`)
  ...
  return (
    <div className={styles.top}>
      ...
      <div>
      <label>
        <select className={styles.common} onChange={handleCountryChange} value={selectedCountry}>
